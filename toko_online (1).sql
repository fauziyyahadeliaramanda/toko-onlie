...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2021 at 03:06 PM
...
CREATE TABLE `detail_transaksi` (
  `id_detail_transaksi` int(15) NOT NULL,
...
(1, 'gelato stoberi', 'terbuat dari susu pilihan, yang memiliki cita rasa yang sangat enak.', '25000', ''),
(2, 'gelato coklat', ' enak bgt', '25000', ''),
(3, 'gelato bluberi', 'asem', '25000', ''),
(4, 'gelato jeruk', ' enak bgt', '25000', ''),
(5, 'gelato pisang', 'enakkkk', '25000', '');
...
--
ALTER TABLE `detail_transaksi`
  MODIFY `id_detail_transaksi` int(15) NOT NULL AUTO_INCREMENT;
