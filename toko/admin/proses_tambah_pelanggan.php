...
if($_POST){
    ...
    if(empty($nama_pelanggan)){
        ...
        echo"<script>alert('telp tidak boleh kosong');location.href='tambah_petugas.php;</script>";
    }else{
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into pelanggan(nama_pelanggan,alamat,telp)
        value
        ('".$nama_pelanggan." ','".$alamat." ','".$telp."')")or
